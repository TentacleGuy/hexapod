...
one or more servos are told to go a new end point and that they should take a specific time to get there.
...
New Class cServoGroupMove - used to start a new group move.  There is one instance of this class defined ServoGroupMove.
...
moving - Returns a bitmask of the servos that are still moving.  The bits are in the order the servos were created.
